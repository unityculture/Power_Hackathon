...
month_1 <- rep(c(1,3,5,7,9), each=891)
month_2 <- rep(11, each=891)
...
edu_104 <- read.csv('origin_data/104_edu_twomonth.csv', stringsAsFactors = F)
substr(edu_104[substr(edu_104$行政區域, 1, 2) == '鳳山', 3], 3, 3) <- '區'
substr(edu_104[substr(edu_104$行政區域, 1, 2) == '三民', 3], 3, 3) <- '區'
edu_104[edu_104$行政區域 == '那瑪夏達卡努瓦里', 3] <- '那瑪夏區達卡努瓦里'
edu_104[edu_104$行政區域 == '那瑪夏瑪雅里', 3] <- '那瑪夏區瑪雅里'
edu_104[edu_104$行政區域 == '那瑪夏南沙魯里', 3] <- '那瑪夏區南沙魯里'
